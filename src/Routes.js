...
const ImageGallery = lazy(() => import('./views/Dashboard/Default/ImageGallery'));
// const Indexs = lazy(() => import('./views/Dashboard/Default/Indexs'));
    ...
    return (
        <AnimatePresence>
            <Suspense fallback={<Loader />}>
                <Switch>
                    <Redirect exact from="/materially" to="/dashboard/default" />
                      <Route path={[]}>
                        <MinimalLayout>
                        ...
                        <MainLayout>
                            <Switch location={location} key={location.pathname}>
                                ...
                                <NavMotion>
                                    ...
                                    <Route path="/http://127.0.0.1:4000" component={ImageGallery} />
                                    {/* <Route path="/dsah34" component={Indexs} /> */}
                                    <Route path="/widget/data" component={ImageGallery} />
